        ...
        <section className="container mx-auto grid grid-cols-1 justify-between items-start gap-12 px-4 py-12 md:grid-cols-2 md:px-6 lg:py-16">
          <div className="flex flex-col items-start justify-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-8">
              Cancers that spread in the body often end up in the skeleton, particularly in the hip bones (proximal femur). Hip bones that are weakened or broken from cancer have historically been stabilized with hardware (metal nails, screws and plates) to avoid or to fix cancer-related fractures. However, cancer treatments continue to improve, and many patients with cancer in their hip bones are living longer. 
            </p>
            <p className="text-gray-600 dark:text-gray-400 mb-8">
            Although this is a positive development, patients that have hip stabilizing surgery are now living longer than the hardware was designed to last and, as a result, these patients are experiencing many more problems in the years after surgery, including cancer recurrence and hardware breakage. In the meantime, surgeons have begun to consider removing larger sections of the affected bone and replacing it with a large hip replacement (endoprosthetic replacement). This is more complex than the usual surgery, and may have higher risks for complications, but is less likely to result in problems such as cancer recurrence and hardware breakage. There have yet to be any clinical trials to determine which surgery is better overall. The Proximal FEmur Reconstruction or InternalFixation fOR Metastases (PERFORM) trial will assign patients by chance (randomize) to 1 of the 2 surgeries. The patients will be followed for 1 year to see which surgery results in better outcomes.
            </p>
            <p className="text-gray-600 dark:text-gray-400 mb-8">
              Ultimately, the PERFORM trial has the potential to effect significant changes in orthopaedic oncology clinical practice and improve the oncologic, functional, and quality of life outcomes of patients with cancers that have metastasized to their proximal femur.
            </p>
          </div>
          <div className="flex flex-col items-start justify-center">
